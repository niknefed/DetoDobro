...
class User(AbstractUser):
    is_director = models.BooleanField(default=False, verbose_name='Представитель')
    is_children = models.BooleanField(default=False, verbose_name='Воспитанник')

    class Meta:
        verbose_name = f'Пользователь'
...
class Children(models.Model):
    ...
    age = models.CharField(max_length=99, blank=True, verbose_name='Возраст')
    sex = models.CharField(max_length=1, blank=True, verbose_name='Пол')
